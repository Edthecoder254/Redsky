...
import com.marvedie.redskyshop.shoppingcart.adapters.CheckRecyclerViewAdapter;
import com.marvedie.redskyshop.shoppingcart.entities.ProductObject;
import com.marvedie.redskyshop.shoppingcart.helpers.MySharedPreference;
import com.marvedie.redskyshop.shoppingcart.helpers.SimpleDividerItemDecoration;
...
public class CheckoutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent paymentIntent = new Intent(CheckoutActivity.this, com.marvedie.redskyshop.shoppingcart.PayPalCheckoutActivity.class);
