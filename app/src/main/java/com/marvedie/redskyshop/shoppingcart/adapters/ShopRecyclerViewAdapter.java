package com.marvedie.redskyshop.shoppingcart.adapters;
    ...
    public void onBindViewHolder(ShopRecyclerViewHolder holder, int position) {
        ...
        holder.produceImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent productIntent = new Intent(context, com.marvedie.redskyshop.shoppingcart.ProductActivity.class);
